"""
Django settings for jcc_40572 project.
...
WSGI_APPLICATION = 'jcc_40572.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jcc_40572 API",
    "DESCRIPTION": "API documentation for jcc_40572 App",
    "VERSION": "v1",
}
